...
public class JNIInheritBaseParam extends Param {
	...
	private JNIInheritBaseParam getSelf(){
		return this;
	}
	private class JNIInheritBaseParamConvert implements ParamConvertAdapter {
		@Override
	...
	public ParamConvertAdapter getConvert() {
		return new JNIInheritBaseParamConvert();
	}
