...
public class JNIPSOBaseParam extends Param {
	...
	private JNIPSOBaseParam getSelf(){
		return this;
	}
	private class JNIPSOBaseParamConvert implements ParamConvertAdapter {
		@Override
		public Map<String, Object> toMap() {
			Map<String,Object> map = new HashMap<String,Object>();
			Field[] fields = JNIPSOBaseParam.class.getDeclaredFields();
		...
		public List<Object> getType() {
			Object[] type = {null,null,null,null,null};
	...
	public ParamConvertAdapter getConvert() {
		return new JNIPSOBaseParamConvert();
	}
