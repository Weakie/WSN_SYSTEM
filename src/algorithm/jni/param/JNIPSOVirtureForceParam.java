...
public class JNIPSOVirtureForceParam extends Param {
	// for Particle
	...
	private JNIPSOVirtureForceParam getSelf(){
		return this;
	}
	private class JNIPSOVirtureForceParamConvert implements ParamConvertAdapter {
		@Override
		public Map<String, Object> toMap() {
			Map<String,Object> map = new HashMap<String,Object>();
			Field[] fields = JNIPSOVirtureForceParam.class.getDeclaredFields();
	...
	public ParamConvertAdapter getConvert() {
		return new JNIPSOVirtureForceParamConvert();
	}
