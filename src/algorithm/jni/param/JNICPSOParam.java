...
public class JNICPSOParam extends Param {
	...
	private JNICPSOParam getSelf(){
		return this;
	}
	private class JNICPSOParamConvert implements ParamConvertAdapter {
		@Override
		public Map<String, Object> toMap() {
			Map<String,Object> map = new HashMap<String,Object>();
			Field[] fields = JNICPSOParam.class.getDeclaredFields();
	...
	public ParamConvertAdapter getConvert() {
		return new JNICPSOParamConvert();
	}
