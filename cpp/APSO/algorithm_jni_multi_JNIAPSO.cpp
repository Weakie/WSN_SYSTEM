#include "jni.h"
#include "algorithm_jni_multi_JNIAPSO.h"
#include "NodeList.h"
#include "Particle.h"
#include "myutil.h"
#include "APSO.h"
...
(JNIEnv *env, jobject obj, jint parSize, jint num){
	...
	jfieldID paramFid = env->GetFieldID(cls,"param","Lalgorithm/jni/param/JNIAPSOParam;");
	...
	Particle::initStaticParams(num,wMax,wMin,c1,c2,f1,f2);

	//run
	APSO pso(parSize,num);
	pso.run();
