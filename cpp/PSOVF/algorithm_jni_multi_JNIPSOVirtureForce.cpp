#include "jni.h"
#include "algorithm_jni_multi_JNIPSOVirtureForce.h"
#include "NodeList.h"
#include "Particle.h"
#include "myutil.h"
#include "PSO.h"
...
(JNIEnv *env, jobject obj, jint parSize, jint num){
	...
	jfieldID paramFid = env->GetFieldID(cls,"param","Lalgorithm/jni/param/JNIPSOVirtureForceParam;");
	...
	jfieldID wFid = env->GetFieldID(paramClass,"w","D");
	jfieldID c1Fid = env->GetFieldID(paramClass,"c1","D");
	jfieldID c2Fid = env->GetFieldID(paramClass,"c2","D");
	...
	double w = env->GetDoubleField(paramObj,wFid);
	double c1 = env->GetDoubleField(paramObj,c1Fid);
	double c2 = env->GetDoubleField(paramObj,c2Fid);
	...
	Particle::initStaticParams(w,c1,c2,c3,f1,f2);
