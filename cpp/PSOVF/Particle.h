...
public:
	...
	* 初始化静态运行参数
	*/
	static void initStaticParams(double w,double c1,double c2,double c3,double f1,double f2);
...
void Particle::initStaticParams(double w,double c1,double c2,double c3,double f1,double f2){
	Particle::w = w;
	Particle::c1 = c1;
	Particle::c2 = c2;
	Particle::c3 = c3;
