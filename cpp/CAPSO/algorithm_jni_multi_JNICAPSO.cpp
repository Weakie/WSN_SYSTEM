#include "jni.h"
#include "algorithm_jni_multi_JNICAPSO.h"
#include "NodeList.h"
#include "Particle.h"
#include "myutil.h"
#include "CAPSO.h"
...
(JNIEnv *env, jobject obj, jint parSize, jint num){
	...
	jfieldID paramFid = env->GetFieldID(cls,"param","Lalgorithm/jni/param/JNICAPSOParam;");
	...
	Particle::initStaticParams(num,wMax,wMin,c1Begin,c1End,c2Begin,c2End,f1,f2);

	//run
	CAPSO pso(parSize,num);
	pso.run();
