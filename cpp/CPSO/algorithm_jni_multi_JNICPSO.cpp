#include "jni.h"
#include "algorithm_jni_multi_JNICPSO.h"
#include "NodeList.h"
#include "Particle.h"
#include "myutil.h"
#include "CPSO.h"
...
(JNIEnv *env, jobject obj, jint parSize, jint num){
	...
	jfieldID paramFid = env->GetFieldID(cls,"param","Lalgorithm/jni/param/JNICPSOParam;");
	...
	Particle::initStaticParams(w,c1,c2,f1,f2);

	//run
	CPSO pso(parSize,num);
	pso.run();
