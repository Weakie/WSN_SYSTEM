#include "jni.h"
#include "algorithm_jni_multi_JNIInheritBase.h"
#include "NodeList.h"
#include "myutil.h"
...
(JNIEnv *env, jobject obj, jint popNum, jint loopNum){
	...
	jfieldID paramFid = env->GetFieldID(cls,"param","Lalgorithm/jni/param/JNIInheritBaseParam;");
	...
	Individual::initStaticValues(nodeSize,posMax,posMin,f1,f2);
